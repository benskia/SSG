...
Additional text
        """
        result = markdown_to_html_node(md).to_html()
        expect = "<div><p>A <b>bolded</b> paragraph</p><p>An <i>italicized</i> paragraph</p><p>A <code>coded</code> paragraph\nAdditional text</p></div>"
        self.assertEqual(result, expect)
...
#         """
#         result = markdown_to_html_node(md).to_html()
#         expect = "<code>Some <b>bolded</b> code\n\nWithin a <i>code block</i></code>"
#         self.assertEqual(result, expect)
#
#     def test_paragraphs(self):
#         md = """
